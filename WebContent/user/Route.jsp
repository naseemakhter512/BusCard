...
<%@page import="in.co.buscard.common.controller.RouteCtl"%>
...
<jsp:useBean id="model" class="in.co.buscard.common.model.RouteModel"
	scope="request" />
...
<font
   ...
   <h3 style="margin-bottom: 1rem;">Add Route Details</h3>
   </div>
   </div>
   <form method="POST" action="RouteCtl">
   ...
   <div class="row">
    ...
    <label style="font-weight: normal;">Route Id<span class="text-danger">*</span></label>
    <input type="text" name="routeId" value="<%=DataUtility.getStringData(model.getRouteId())%>" class="form-control"  required="">
    </div>
     <div class="form-group col-md-6">
      <label style="font-weight: normal;">Route Name<span class="text-danger">*</span></label>
     <input type="text" name="routeName" value="<%=DataUtility.getStringData(model.getRouteName())%>" class="form-control" required="">
    </div>
   </div>
   <div class="row">
    <div class="form-group col-md-6">
        <label style="font-weight: normal;">KM<span class="text-danger">*</span></label>
    	<input type="text" name="km" value="<%=DataUtility.getStringData(model.getKm())%>" class="form-control"  required="">
    </div>
     <div class="form-group col-md-6">
