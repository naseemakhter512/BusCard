			...
			<div class="login-block">
				...
				<form action="<%=ORSView.LOGIN_CTL%>" method="POST">
					...
					<input type="submit" name="operation" value="<%=LoginCtl.OP_SIGN_IN%>">	
						<div class="forgot-top-grids" style="text-align: left !important">
						
						<div class="forgot">
							<a href="<%=ORSView.FORGET_PASSWORD_CTL%>">Forgot password?</a>
						<a style="float: right;" href="images/Form.pdf" class="button" download><i class="fa fa-download"></i>Download Form</a>
						</div>
